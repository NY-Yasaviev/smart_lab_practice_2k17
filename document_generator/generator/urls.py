...
urlpatterns = [
    ...
    url(r'^practice_(?P<id>\d+)/diary/new/', views.new_diary_record, name='new_diary'),
    url(r'^practice_(?P<id>\d+)/diary/(?P<diary_record_id>\d+)/', views.edit_diary_record, name='edit_diary_record'),
