...
urlpatterns = [
    ...
    url(r'^practice_(?P<id>\d+)/report/view/', views.report_view, name='report_view'),
    url(r'^practice_(?P<id>\d+)/report/d/', views.report_download, name='report_download'),
    url(r'^practice_(?P<id>\d+)/report/', views.report, name='report'),
    url(r'^practice_(?P<id>\d+)/individual/view/', views.individual_view, name='individual_view'),
    url(r'^practice_(?P<id>\d+)/individual/d/', views.individual_download, name='individual_download'),
    url(r'^practice_(?P<id>\d+)/individual/', views.individual, name='individual'),
    url(r'^practice_(?P<id>\d+)/pass/view/', views.pass_view, name='pass_view'),
